...
#     --val_dir /cache/SIDD/val --embed_dim 32 --warmup
 ...
 python3 ./train.py --arch Uformer --batch_size 2 --gpu '0' --train_ps 128 --train_dir ../datasets/RICE1/train --env 32_0701_1 --val_dir ../datasets/RICE1/val --embed_dim 16 --warmup