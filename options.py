...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--nepoch', type=int, default=800, help='training epochs')
        ...
        parser.add_argument('--pretrain_weights',type=str, default=r'.\uformer512_log\log\Uformer16_0606_rice1_original_batch2_epoch800\models\model_best.pth', help='path of pretrained_weights')
        parser.add_argument('--optimizer', type=str, default ='adamw', help='optimizer for training')
        parser.add_argument('--lr_initial', type=float, default=0.000012, help='initial learning rate')
        ...
        parser.add_argument('--shift_size', default='0', help='shift_size')
        # args for vit
        ...
        parser.add_argument('--train_dir', type=str, default =r'D:\research\SpA-GAN_for_cloud_removal-master\data\RICE_DATASET\RICE2',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='../datasets/RICE1/val',  help='dir of train data')
