...
parser.add_argument('--input_dir', default=r'D:\research\Uformer-main\datasets\teacher',
    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default=r'D:\research\Uformer-main\datasets\teacher\result',
    type=str, help='Directory for results')
parser.add_argument('--weights', default=r'./uformer512_log\Uformer_uniformerRICE2_0813_uniformer_lepe\models\model_best.pth',
    type=str, help='Path to weights')
parser.add_argument('--gpus', default='0', type=str, help='CUDA_VISIBLE_DEVICES')
parser.add_argument('--arch', default='Uformer_uniformer', type=str, help='arch')
